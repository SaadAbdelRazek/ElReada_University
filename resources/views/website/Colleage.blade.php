...
<body>
    ...
    <section class="about">
        <div class="pos-where">
            <p>الرئيسية | الدراسة فى الجامعة | الكليات</p>
        </div>
    </section>
    <!--========================================== Colleges =============================================-->
        ...
        <div class="college-items-dis">
            <div class="college-card-des">
                <div class="college-crd-cnt">
                    <a class="my-col-desc" href="Collegae_ Faculty.html">كلية الحاسبات والذكاء
                        الإصطناعى</a>
                </div>
            </div>
            ...
            <div class="college-card-des">
                <div class="college-crd-cnt">
                    <a class="my-col-desc" href="Collegae_ Faculty.html">كلية الهندسة</a>
                </div>
            </div>

            <div class="college-card-des">
                <div class="college-crd-cnt">
                    <a class="my-col-desc" href="Collegae_ Faculty.html">كلية الطب</a>
                </div>
            </div>

            <div class="college-card-des">
                <div class="college-crd-cnt">
                    <a class="my-col-desc" href="Collegae_ Faculty.html">كلية التربية</a>
                </div>
            </div>

            <div class="college-card-des">
                <div class="college-crd-cnt">
                    <a class="my-col-desc" href="Collegae_ Faculty.html">كلية العلوم</a>
                </div>
            </div>
            <div class="college-card-des">
                <div class="college-crd-cnt">
                    <a class="my-col-desc" href="Collegae_ Faculty.html">كلية العلوم الشرعية</a>
                </div>
            </div>
        </div>
    </section>
